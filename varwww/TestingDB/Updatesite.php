...
if($user!="" && $autoid!=""){
    ...
    $altitude_m=$_POST['altitude']; $gps_accuracy=$_POST['accuracy']; $time=$_POST['time'];
    ...
    $jobkey=$_POST['jobkey']; $usercounty=$_POST['usercounty'];
    $lt=$_POST['longitude2']; 
    ...
    // create new Site
    $sql1="UPDATE Site SET site_id='$tag',        
    type='$typecode',
    LONGITUDE='$lt',LATITUDE='$lat',altitude = '$altitude_m',
    gps_accuracy = '$gps_accuracy',
    updated_on = '$time',
    updated_by='$user',
    job = '$jno',
    stage = '$stage',
    gps_time = '$gpstime',OWNER_CD = '$ownerCD',
    owner_key = '$ownerkey',
    job_key='$jobkey',
    updated_from= 'collector apk',
    gps_offset_latitude ='$gps_offset_latitude',
    gps_offset_longitude ='$gps_offset_longitude',
    gps_offset_bearing ='$gps_offset_bearing',
    gps_offset_distance ='$gps_offset_distance',                
    COUNTY='$usercounty'  WHERE tag_number = '$tag'";


    $tagres=mysqli_query($con,$sql1);
