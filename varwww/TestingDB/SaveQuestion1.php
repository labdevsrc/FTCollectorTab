 ...
 /*$sql="insert into Site (owner,OWNER_CD,tag_number,site_id,type,SiteName,manufactured,
    manufacturer,Model,Pictures,created_by,created_on,height,depth,width,CLEAR_ZONE_IND,LONGITUDE,LATITUDE) 
values('$owner1','$ownerCD','$tag_number1','$tag_number1','$type1','$SiteName1',
   ...
   $sql="insert into Site (owner,OWNER_CD,tag_number,site_id,type,SiteName,manufactured,
    ...
    '$DISTANCE_TO_EOTL1','$bucket_truck1','$jno','$serialno','$ground','$key','$ktype','$traveldir','$plansheet','$psitem','$stage','$gpstime','$usercounty','$otag','$roadway','$pid','$accuracy','$altitude','$ownerkey','$jobkey','$loct','$staddr','$pscode','$btype','$laneclosure','$dotdis','$powr','$elecsite','$comm','$commprovider','$sitaddr','$udsowner','$orientation','$createdfrm','$offlongi','$offlattti')";
     ...
     //mysqli_query($con,$sql);
      ...
      {              
		...
		LONGITUDE,LATITUDE,Model,intersection,material,mounting,filter_count,filter,CLEAR_ZONE_IND,DISTANCE_TO_EOTL,
	...
	values('$keyval','$owner1','$jno','$ownerCD','$ownerkey','$jobkey','$tag_number1','$tag_number1','$type1','$SiteName1','$loct','$gpstime','$usercounty',
		'$LONGITUDE1','$LATITUDE1','$Model1','$intersection1','$material1','$mounting1','$filter_count1','$filter1','$CLEAR_ZONE_IND1','$DISTANCE_TO_EOTL1',
	...
	$sqlquestion2="insert into Site (manufactured,Pictures,height,
        depth,width,CLEAR_ZONE_IND,
	...
	values('$manufactured1','$Pictures1','$height1','$depth1','$width1','$CLEAR_ZONE_IND1',
        ...
        $ins=mysqli_query($con,$sqlquestion1);         
        ...
        $msg1= array("d" => "Sucessfully inserted...","sts" =>"1", "max_id" => $site_id1);
        $msg2= array("d" => "Something 44444 went wrong.","sts" =>"0");
        if($ins){
